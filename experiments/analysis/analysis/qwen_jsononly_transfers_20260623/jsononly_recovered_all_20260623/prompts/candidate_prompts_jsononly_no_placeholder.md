...
Do not output reasoning, analysis, caveats, markdown, or prose.
Return exactly one line and nothing else:
FINAL_ANSWER_JSON:{"label":"0","uncertainty_option_index":0|1|2,"evidence":"max 8 words","evidence_type":"stated_text_fact|objective_visible_evidence|elimination|insufficient_evidence","uncertainty_signal":true|false,"protected_attribute_risk":true|false,"schema_version":"reasoner_output_v3"}

Rules for the JSON:
- label must be exactly one JSON string: "0" or "1" or "2". Never output "0|1|2".
...
```text
CRITICAL OUTPUT RULE: Output exactly one line: FINAL_ANSWER_JSON:{...}. No reasoning text.
...
Do not explain your reasoning. Output only the required FINAL_ANSWER_JSON line.
```
